...
<head>
  ...
  <title>Media Informatic | Prestasi</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/Prestasi/add_Prestasi'?>"><i class="fa fa-thumb-tack"></i> Add Prestasi</a></li>
            <li class="active"><a href="<?php echo base_url().'admin/Prestasi'?>"><i class="fa fa-list"></i> Prestasi List</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/Prestasi/add_Prestasi'?>"><span class="fa fa-plus"></span> Add Prestasi</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/Prestasi/get_edit/'.$port_id;?>"><span class="fa fa-pencil"></span></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://mediainformatic.com">Media Informatic</a>.</strong> All rights reserved.
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
                     ...
                     <input type="hidden" value="<?php echo $port_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Prestasi <b><?php echo $port_judul;?></b> ?</p>
