			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'portfolio'?>">Prestasi</a></li>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Prestasi Mahasiswa Infomartika</h2>
		   					<p class="fh5co-lead"> Universitas Negeri Surabaya </p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>Penghargaan yang telah kami capai.</p>
				</div>
			</div>
		</div>
		<?php
